...
#' @param ... arguments to be passed to methods. For more details about the arguments, see \link{\code{tpm}}.
#'
...
#' \item \code{guessing} a vector of guessing parameters for each item.
